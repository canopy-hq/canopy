...
export function GitHubStatus() {
  ...
  const handlePress = () => {
    void navigateToSettings('git', navigate);
  };

  if (connection) {
    return (
      <Tooltip label={connection.username} placement="left">
        <Button variant="ghost" iconOnly onPress={handlePress} aria-label={connection.username}>
          <img
  ...
  return (
    <Tooltip label="Connect GitHub" placement="left">
      <Button variant="ghost" iconOnly onPress={handlePress} aria-label="Connect GitHub">
        <GitHubIcon />
      </Button>
    </Tooltip>
  );
