...
export function ConnectionSection() {
  ...
  return (
    <div className="space-y-8">
      <section>
        <h2 className="mb-1 text-ui-base font-semibold text-text-primary">GitHub</h2>
        <p className="mb-4 text-ui-md text-text-muted">
...
function WorktreeBaseDir() {
  ...
  return (
    <section>
      <h2 className="mb-1 text-ui-base font-semibold text-text-primary">Worktree Base Directory</h2>
      ...
      <div className="flex items-center gap-2 rounded-lg bg-bg-secondary px-4 py-3">
        <span className="min-w-0 flex-1 truncate font-mono text-ui-md text-text-primary">
          {currentDir}
        </span>
...
function GitHubAuth({
  ...
  if (auth.status === 'loading') {
    return <div className="text-ui-md text-text-muted">Checking connection...</div>;
  }
  ...
  if (auth.status === 'connected') {
    return (
      <div className="flex items-center gap-3 rounded-lg bg-bg-secondary px-4 py-3">
        ...
        />
        <span className="flex-1 text-ui-base font-medium text-text-primary">
    ...
    return (
      <div className="space-y-3 rounded-lg bg-bg-secondary px-4 py-3">
        <div className="flex items-center justify-between">
          <span className="text-ui-md text-text-muted">Enter this code on GitHub:</span>
          <Button
            size="sm"
        ...
        <div className="flex items-center justify-between">
          <span className="text-ui-md text-text-muted">Waiting for authorization...</span>
